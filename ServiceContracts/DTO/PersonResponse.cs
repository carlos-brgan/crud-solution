...
{
    /// <summary>
    /// Represents DTO class that is used as return tupe of most methods of Persons Service
    /// </summary>
    public class PersonResponse
    {
        ...
        /// <summary>
        /// Compares the current object data with the parameter objects
        /// </summary>
        ...
        public override bool Equals(object? obj)
        {
            ...
            return PersonID == person.PersonID && PersonName == person.PersonName && this.Email == person.Email &&
    ...
    {
        /// <summary>
        /// Converts the current object of Person into a new object of PersonResponse type
        /// </summary>
